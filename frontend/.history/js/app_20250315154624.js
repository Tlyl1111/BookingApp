...
const contractAddress = "0xdBBE6bbCEC0A24e2aa4F0De81248d94C50F958e3";
const contractABI = [
  {
    inputs: [
      {
...
async function showInitializeBookingForm(room) {
  ...
  .addEventListener("submit", async function (event) {
    ...
    // Ép kiểu roomId thành kiểu string
    let roomId = String(room.roomId);  // Chuyển roomId thành kiểu string
    ...
    // Chuyển formattedStartTime thành chuỗi bằng cách sử dụng String()
    const uintStartTime = String(formattedStartTime);  // Chuyển startTime thành kiểu string
