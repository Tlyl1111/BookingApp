  ...
  try {
    ...
    document
      ...
      .addEventListener("submit", async function (event) {
        ...
        const minutes = parseUnits(document.getElementById("minutes").value, 10);

        const formattedStartTime = formatDateToYYYYMMDDHHMMSS(startTime);
        let roomId = parseUnits(room.roomId, 10); 
        ...
        const uintStartTime = parseUnits(formattedStartTime, 10);
