...
async function fetchAllBookings() {
  ...
  try {
    ...
    allBookings.forEach((booking) => {
      const startDate = new Date(Number(booking.startTime) * 1000); // Convert BigInt to number
      const endDate = new Date(Number(booking.endTime) * 1000); // Convert BigInt to number
